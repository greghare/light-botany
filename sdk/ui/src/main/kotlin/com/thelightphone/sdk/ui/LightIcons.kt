...
object LightIcons {
    ...
    object BOOK_OPEN : LightIconConfiguration(
        name = "open book",
        darkModeResource = R.drawable.ic_book_open_white,
        lightModeResource = R.drawable.ic_book_open_black
    )
    ...
    object EYE : LightIconConfiguration(
        name = "show",
        darkModeResource = R.drawable.ic_eye_white,
        lightModeResource = R.drawable.ic_eye_black
    )
    object EYE_OFF : LightIconConfiguration(
        name = "hide",
        darkModeResource = R.drawable.ic_eye_off_white,
        lightModeResource = R.drawable.ic_eye_off_black
    )
